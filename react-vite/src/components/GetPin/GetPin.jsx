    ...
    <div className="getPin-container">
      <div className="getPin-left">
        ...
        <div style={{display:'flex', flexDirection:'row', gap:'60px', alignItems:'center'}}>
          ...
          <div onClick={() => likeClick()} disabled={canLike} style={{ fontSize:'20px', fontWeight:'bold', color:'#ff2f00'}}>
            <i className="fa-solid fa-heart" style={{color: '#ff2f00', marginRight:'5px', cursor:'pointer'}}></i> {currentLikes}
          </div>
        </div>
      </div>
